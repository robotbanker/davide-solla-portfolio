...
<html lang="en-GB" data-analytics="enabled">
  <head>
    ...
    <link rel="stylesheet" href="/field-notes.css?v=20260905-7b18b96159">
  ...
  <body>
    <header class="site-header is-scrolled" data-header>
      ...
      <nav class="site-nav" data-nav aria-label="Main navigation">
        <a href="/#work">Work</a><a href="/#services">Services</a><a href="/#fine-art">Fine Art</a><a href="/#about">About</a><a href="/#contact">Contact</a><a href="/field-notes" aria-current="page">Field Notes</a><a href="/client-area.html">Client Area</a><a class="social-link" href="https://www.instagram.com/davide.studios/" target="_blank" rel="noreferrer" aria-label="Davide Solla on Instagram"><svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><rect x="2.5" y="2.5" width="19" height="19" rx="5.5"></rect><circle cx="12" cy="12" r="4.2"></circle><circle cx="17.3" cy="6.7" r="1.2"></circle></svg></a>
      </nav>
    </header>
...
const handleFieldNotesPageRequest = (req, res) => {
  ...
  const archiveAlias = requestUrl.searchParams.get("archive") === "1";
  const latestAlias = (pathname === "/field-notes" && !requestUrl.searchParams.get("issue"))
  ...
  const issueId = latestAlias
    ? entries[0]?.issueId
    : routeMatch?.[1] || cleanText(requestUrl.searchParams.get("issueId"), 20);
  ...
  const publicRoute = latestAlias || Boolean(routeMatch) || requestUrl.searchParams.get("public") === "1";
