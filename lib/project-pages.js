...
<html lang="en-GB" data-analytics="enabled">
  <head>
    ...
    <link rel="stylesheet" href="/project-page.css?v=2">
    <script type="application/ld+json">${jsonLd}</script>
  </head>
  <body class="project-page">
    <a class="skip-link" href="#project-gallery">Skip to project images</a>
    ...
    <main>
      <article>
        ...
        <section class="project-gallery" id="project-gallery" aria-label="${escapeHtml(album.title)} image gallery" tabindex="-1">
