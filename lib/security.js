...
const contentSecurityPolicy = "default-src 'self'; base-uri 'none'; connect-src 'self'; font-src 'self'; form-action 'self'; frame-ancestors 'none'; frame-src 'none'; img-src 'self' data: blob: https:; object-src 'none'; script-src 'self' 'sha256-1XmWtysKAzN9AuRW9+HNK88+6tfnvugwol2e6owcCrI='; style-src 'self'; style-src-attr 'unsafe-inline'";
