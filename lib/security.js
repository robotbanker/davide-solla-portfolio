...
const contentSecurityPolicy = "default-src 'self'; base-uri 'none'; connect-src 'self'; font-src 'self'; form-action 'self'; frame-ancestors 'none'; frame-src 'none'; img-src 'self' data: blob: https:; object-src 'none'; script-src 'self' 'sha256-R1uaZHWYzppApCvDocdOpS69oTgzRBLYecQ/n6RfIGk=' 'sha256-te71Eqs5ujX5KZiCh/Opd6GJTyfvc2AIT6hSli2ZudQ='; style-src 'self'; style-src-attr 'unsafe-inline'";
