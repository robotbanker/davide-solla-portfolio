    ...
    ${(fashion.stories || []).map((story) => `
      <tr>
        <td style="padding:0 0 30px;">
          ${renderImage(story.image, issue, 300)}
          ...
          <p style="color:${tokens.muted};font-family:${tokens.sans};font-size:10px;line-height:1.4;margin:0 0 15px;text-transform:uppercase;">Source visual: ${escapeHtml(story.imageCredit || "Usage pending")}</p>
